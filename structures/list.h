#ifndef __ZHMU_LIST_H__
#define __ZHMU_LIST_H__
...
#define LIST_NEXT_IP(it, ip) \
	(it)->ip ## _next

#define LIST_PREV_IP(it, ip) \
	(it)->ip ## _prev
...
#define LIST_APPEND(q, item) \
	LIST_APPEND_IP(q, li, item)

#define LIST_PREPEND(q, item) \
	LIST_PREPEND_IP(q, li, item)

#define LIST_POP_HEAD(q) \
	LIST_POP_HEAD_IP(q, li)

#define LIST_POP_TAIL(q) \
	LIST_POP_TAIL_IP(q, li)

#define LIST_NEXT(it) \
	LIST_NEXT_IP(it, li)

#define LIST_REMOVE(q, it) \
	LIST_REMOVE_IP(q, li, it)

#define LIST_PREV(it) \
	LIST_PREV_IP(it, li)

#define LIST_INSERT_BEFORE(q, pos, item) \
	LIST_INSERT_BEFORE_IP(q, li, pos, item)

#define LIST_FOREACH(q, it, TYPE) \
	LIST_FOREACH_IP(q, li, it, TYPE)

#define LIST_FOREACH_SAFE(q, it, TYPE) \
	LIST_FOREACH_SAFE_IP(q, li, it, TYPE)

#define LIST_FOREACH_REVERSE(q, it, TYPE) \
	LIST_FOREACH_REVERSE_IP(q, li, it, TYPE)

#define LIST_FOREACH_REVERSE_SAFE(q, it, TYPE) \
	LIST_FOREACH_REVERSE_SAFE_IP(q, li, it, TYPE)

#endif /* __ZHMU_LIST_H__ */
